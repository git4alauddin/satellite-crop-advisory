...
-- S10: latest window healthy to validate latest-observation cards
...
VALUES
    ...
    -- S10 (latest healthy)
    (1, '2025-05-01', '2025-05-15', 13, 13, 13, 6, 0.61, -0.14, 20.1,  0.05,  0.02, -0.5, 'healthy',  'healthy',  'healthy',  NOW() - INTERVAL '1 day')
